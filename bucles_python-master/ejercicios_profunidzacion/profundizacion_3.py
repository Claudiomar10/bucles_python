...
print()
print(f'La suma total de las temperaturas dadas es= {suma_total} grados')
print()
print(f'La temperatura maxima es= {temperatura_maxima} grados')
print()
print(f'La temperatura minima es= {temperatura_minima} grados')
print()
